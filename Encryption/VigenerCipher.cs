...
namespace Encryption
{
  ...
  public class VigenerCipher
  {
    ...
    public void DecryptText(string text, Language language)
    {
    ...
    private double GetChi(string text, char letter)
    {
      ...
      switch (language)
      {
        case Language.Slovak:
          perc = text.Length * AplhabetDictionary.Slovak[letter];
          break;
        case Language.English:
          perc = text.Length * AplhabetDictionary.English[letter];
          break;
        default:
